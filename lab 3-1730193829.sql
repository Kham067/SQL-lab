...
CREATE TABLE [department] (
	...
	[new_field] nvarchar(40) NOT NULL,
...
ALTER TABLE [Order] ADD CONSTRAINT [Order_fk2] FOREIGN KEY ([product_id]) REFERENCES [product]([product_id]);

ALTER TABLE [Order] ADD CONSTRAINT [Order_fk3] FOREIGN KEY ([customer_id]) REFERENCES [customer]([customer_id]);