...
VALUES 
('Sun', 'Lviv', 'Gorodotska', 165),
('Moon', 'Kiyv', 'Shevchenka', 15),
('Saturn', 'Lviv', 'Zelena', 210),
('Mars', 'Rivne', 'Verbova', 57),
('Mercury', 'Ternopil', 'Something', 34),
('Pluton', 'Kiyv', 'Chreschtschatyk', 128);
...
(38,'ViktorKovalov1','Viktor','Kovalov','Assistent' ,'2002-12-19',3,11,3500,175),
...
INSERT INTO invoice (invoice_id, employee_id, customer_id, payment_method,transaction_method,status) VALUES
...
('20220912081145',6,49,2, '2022-09-12 08:11:45',4),
